...
$(function(){
	 ...
	 * jquery的方法传递
	 */
    proProvince.on("blur",function(){
		if(proProvince.val() != null && proProvince.val() != ""){
			validateTip(proProvince.next(),{"color":"green"},imgYes,true);
		}else{
			validateTip(proProvince.next(),{"color":"red"},imgNo+" 省份不能为空，请重新输入",false);
		}
	})/*.on("focus",function(){
		//显示友情提示
	...
	addBtn.bind("click",function(){
		if(proProvince.attr("validateStatus") != "true"){
            proProvince.blur();
